...
\begin{multicols}{2}
    ...
    La formulation de référence repose sur l'écriture des équations en variables primitives, $W = [\rho, V, T]$, et sur l'utilisation d'un schéma explicite de MacCormack~\cite{anderson}. Bien que la formulation ne soit pas conservative, 
